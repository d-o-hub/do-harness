...
| **ASI04** | Agentic Supply Chain Vulnerabilities | ✅ Dev-Loop | `cargo deny` + RustSec sensors, transitive dependency-direction checks, and artifact provenance verification (see [`docs/provenance-trust-model.md`](provenance-trust-model.md)). [`check-deps.sh`](../scripts/check-deps.sh), [`check-audit.sh`](../scripts/check-audit.sh), [`deny.toml`](../deny.toml) |
