...
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr init-db seed init task trace distill errors eval hook doctor metrics maintenance compliance audit-chain completions man help" -f -a "list" -d 'List sensor names'
