...
complete -c do-harness -n "__fish_do_harness_needs_command" -f -a "ci-explain" -d 'Explain a CI run\'s failures and cancellations with local repro commands'
complete -c do-harness -n "__fish_do_harness_needs_command" -f -a "ci" -d 'Explain a CI run\'s failures and cancellations with local repro commands'
...
complete -c do-harness -n "__fish_do_harness_using_subcommand ci-explain" -l format -d 'Output format' -r -f -a "text\t'Human-readable text output'
json\t'Machine-readable JSON output'"
...
complete -c do-harness -n "__fish_do_harness_using_subcommand ci" -l format -d 'Output format' -r -f -a "text\t'Human-readable text output'
json\t'Machine-readable JSON output'"
...
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora ci-explain completions man help" -f -a "version" -d 'Print CLI version information'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora ci-explain completions man help" -f -a "verify" -d 'Run computational sensors'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora ci-explain completions man help" -f -a "list" -d 'List sensor names'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora ci-explain completions man help" -f -a "explain" -d 'Explain which sensors the current change selects, without running them'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora ci-explain completions man help" -f -a "status" -d 'Report verification evidence freshness without running sensors'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora ci-explain completions man help" -f -a "pr" -d 'Deterministic PR analysis (read-only; works in any git repository)'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora ci-explain completions man help" -f -a "skills" -d 'Inspect and select skills by progressive disclosure'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora ci-explain completions man help" -f -a "init-db" -d 'Apply pending database migrations'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora ci-explain completions man help" -f -a "seed" -d 'Seed invariants from plans/invariants.json'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora ci-explain completions man help" -f -a "init" -d 'Scaffold a harness workspace in a target directory'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora ci-explain completions man help" -f -a "task" -d 'Inspect and export task state'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora ci-explain completions man help" -f -a "trace" -d 'Record and list interaction traces'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora ci-explain completions man help" -f -a "distill" -d 'Extract a heuristic from a resolved trace into a skill. Review output against the anti-AI-slop checklist (.agents/skills/skill-creator/references/anti_ai_slop.md)'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora ci-explain completions man help" -f -a "errors" -d 'Inspect and clear fail-fast error signatures'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora ci-explain completions man help" -f -a "loc" -d 'Report line-of-code state for the 500-LOC invariant'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora ci-explain completions man help" -f -a "split" -d 'Extract a large top-level item into a sibling module'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora ci-explain completions man help" -f -a "eval" -d 'Validate skill structure and benchmark skill evals'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora ci-explain completions man help" -f -a "hook" -d 'Manage git hooks that run `do-harness verify`'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora ci-explain completions man help" -f -a "doctor" -d 'Run diagnostic checks on binary resolution and git hook health'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora ci-explain completions man help" -f -a "metrics" -d 'Report harness trends: sensor stats, strikes, eval pass-rate history'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora ci-explain completions man help" -f -a "overlap" -d 'Rank skill pairs by guidance overlap (Tier-2 distinctiveness advisory)'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora ci-explain completions man help" -f -a "maintenance" -d 'Prune old beats and compact the state database'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora ci-explain completions man help" -f -a "compliance" -d 'Print compliance mapping to OWASP Agentic Top 10, NIST AI RMF, and EU AI Act'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora ci-explain completions man help" -f -a "audit-chain" -d 'Recompute workflow event hash chain and report first divergence'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora ci-explain completions man help" -f -a "dora" -d 'Derive DORA deployment metrics from git history (deterministic, read-only)'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora ci-explain completions man help" -f -a "ci-explain" -d 'Explain a CI run\'s failures and cancellations with local repro commands'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora ci-explain completions man help" -f -a "completions" -d 'Generate shell completions'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora ci-explain completions man help" -f -a "man" -d 'Generate man page documentation'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora ci-explain completions man help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
