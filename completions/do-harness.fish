...
complete -c do-harness -n "__fish_do_harness_needs_command" -f -a "pr" -d 'Deterministic PR analysis (read-only; works in any git repository)'
complete -c do-harness -n "__fish_do_harness_needs_command" -f -a "skills" -d 'Inspect and select skills by progressive disclosure'
...
complete -c do-harness -n "__fish_do_harness_needs_command" -f -a "distill" -d 'Extract a heuristic from a resolved trace into a skill. Review output against the anti-AI-slop checklist (.agents/skills/skill-creator/references/anti_ai_slop.md)'
complete -c do-harness -n "__fish_do_harness_needs_command" -f -a "errors" -d 'Inspect and clear fail-fast error signatures'
complete -c do-harness -n "__fish_do_harness_needs_command" -f -a "loc" -d 'Report line-of-code state for the 500-LOC invariant'
complete -c do-harness -n "__fish_do_harness_needs_command" -f -a "split" -d 'Extract a large top-level item into a sibling module'
...
complete -c do-harness -n "__fish_do_harness_needs_command" -f -a "overlap" -d 'Rank skill pairs by guidance overlap (Tier-2 distinctiveness advisory)'
complete -c do-harness -n "__fish_do_harness_needs_command" -f -a "maintenance" -d 'Prune old beats and compact the state database'
...
complete -c do-harness -n "__fish_do_harness_needs_command" -f -a "dora" -d 'Derive DORA deployment metrics from git history (deterministic, read-only)'
...
complete -c do-harness -n "__fish_do_harness_using_subcommand pr; and not __fish_seen_subcommand_from readiness no-effect review help" -l format -d 'Output format' -r -f -a "text\t'Human-readable text output'
json\t'Machine-readable JSON output'"
complete -c do-harness -n "__fish_do_harness_using_subcommand pr; and not __fish_seen_subcommand_from readiness no-effect review help" -l root -d 'Workspace root override (default: walk up from cwd)' -r -f -a "(__fish_complete_directories)"
complete -c do-harness -n "__fish_do_harness_using_subcommand pr; and not __fish_seen_subcommand_from readiness no-effect review help" -l config -d 'Explicit path to do-harness.toml' -r -F
complete -c do-harness -n "__fish_do_harness_using_subcommand pr; and not __fish_seen_subcommand_from readiness no-effect review help" -l color -d 'Color output (auto, always, never)' -r
complete -c do-harness -n "__fish_do_harness_using_subcommand pr; and not __fish_seen_subcommand_from readiness no-effect review help" -l output -d 'Default output file path' -r -F
complete -c do-harness -n "__fish_do_harness_using_subcommand pr; and not __fish_seen_subcommand_from readiness no-effect review help" -s v -l verbose -d 'Verbosity level (-v, -vv)'
complete -c do-harness -n "__fish_do_harness_using_subcommand pr; and not __fish_seen_subcommand_from readiness no-effect review help" -s q -l quiet -d 'Suppress non-error messages'
complete -c do-harness -n "__fish_do_harness_using_subcommand pr; and not __fish_seen_subcommand_from readiness no-effect review help" -l dry-run -d 'Dry run without side effects'
complete -c do-harness -n "__fish_do_harness_using_subcommand pr; and not __fish_seen_subcommand_from readiness no-effect review help" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c do-harness -n "__fish_do_harness_using_subcommand pr; and not __fish_seen_subcommand_from readiness no-effect review help" -s V -l version -d 'Print version'
complete -c do-harness -n "__fish_do_harness_using_subcommand pr; and not __fish_seen_subcommand_from readiness no-effect review help" -a "readiness" -d 'Check merge readiness for a pull request'
complete -c do-harness -n "__fish_do_harness_using_subcommand pr; and not __fish_seen_subcommand_from readiness no-effect review help" -a "no-effect" -d 'Report whether a PR or revision range introduces any effective change'
complete -c do-harness -n "__fish_do_harness_using_subcommand pr; and not __fish_seen_subcommand_from readiness no-effect review help" -a "review" -d 'Emit the semantic residual: changed units evidence could not prove'
complete -c do-harness -n "__fish_do_harness_using_subcommand pr; and not __fish_seen_subcommand_from readiness no-effect review help" -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c do-harness -n "__fish_do_harness_using_subcommand pr; and __fish_seen_subcommand_from review" -l base -d 'Base revision (local mode; requires --head)' -r
complete -c do-harness -n "__fish_do_harness_using_subcommand pr; and __fish_seen_subcommand_from review" -l head -d 'Head revision (local mode; requires --base)' -r
complete -c do-harness -n "__fish_do_harness_using_subcommand pr; and __fish_seen_subcommand_from review" -l format -d 'Output format' -r -f -a "text\t'Human-readable text output'
json\t'Machine-readable JSON output'"
...
complete -c do-harness -n "__fish_do_harness_using_subcommand pr; and __fish_seen_subcommand_from help" -f -a "readiness" -d 'Check merge readiness for a pull request'
...
complete -c do-harness -n "__fish_do_harness_using_subcommand skills; and not __fish_seen_subcommand_from suggest drift help" -f -a "suggest" -d 'Rank skills by relevance to a query using metadata only'
complete -c do-harness -n "__fish_do_harness_using_subcommand skills; and not __fish_seen_subcommand_from suggest drift help" -f -a "drift" -d 'Check manifest-managed shared skills against their pinned digests'
complete -c do-harness -n "__fish_do_harness_using_subcommand skills; and not __fish_seen_subcommand_from suggest drift help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c do-harness -n "__fish_do_harness_using_subcommand skills; and __fish_seen_subcommand_from suggest" -l query -d 'Task description to match against skill metadata' -r
complete -c do-harness -n "__fish_do_harness_using_subcommand skills; and __fish_seen_subcommand_from suggest" -l limit -d 'Maximum number of candidates to return' -r
complete -c do-harness -n "__fish_do_harness_using_subcommand skills; and __fish_seen_subcommand_from suggest" -l format -d 'Output format' -r -f -a "text\t'Human-readable text output'
json\t'Machine-readable JSON output'"
...
complete -c do-harness -n "__fish_do_harness_using_subcommand skills; and __fish_seen_subcommand_from drift" -l manifest -d 'Manifest to read; defaults to `.agents/skills-manifest.toml`' -r -F
complete -c do-harness -n "__fish_do_harness_using_subcommand skills; and __fish_seen_subcommand_from drift" -l format -d 'Output format' -r -f -a "text\t'Human-readable text output'
json\t'Machine-readable JSON output'"
...
complete -c do-harness -n "__fish_do_harness_using_subcommand skills; and __fish_seen_subcommand_from help" -f -a "suggest" -d 'Rank skills by relevance to a query using metadata only'
complete -c do-harness -n "__fish_do_harness_using_subcommand skills; and __fish_seen_subcommand_from help" -f -a "drift" -d 'Check manifest-managed shared skills against their pinned digests'
...
web\t'Web UI sensor pack: viewport text audit, axe accessibility, and console noise sensors (Playwright runners plus the shipped `scripts/web-ui/` audit library)'
node\t'Node/Web JS/TS language pack (typecheck, lint, test, build)'"
...
complete -c do-harness -n "__fish_do_harness_using_subcommand task; and not __fish_seen_subcommand_from export import list show add advance done fail remove help" -f -a "export" -d 'Write the task list to plans/tasks.json or specified output'
complete -c do-harness -n "__fish_do_harness_using_subcommand task; and not __fish_seen_subcommand_from export import list show add advance done fail remove help" -f -a "import" -d 'Validate plans/tasks.json against the state database'
complete -c do-harness -n "__fish_do_harness_using_subcommand task; and not __fish_seen_subcommand_from export import list show add advance done fail remove help" -f -a "list" -d 'Print tasks from the state database'
complete -c do-harness -n "__fish_do_harness_using_subcommand task; and not __fish_seen_subcommand_from export import list show add advance done fail remove help" -f -a "show" -d 'Show details for a specific task'
complete -c do-harness -n "__fish_do_harness_using_subcommand task; and not __fish_seen_subcommand_from export import list show add advance done fail remove help" -f -a "add" -d 'Add a task in `pending` state'
complete -c do-harness -n "__fish_do_harness_using_subcommand task; and not __fish_seen_subcommand_from export import list show add advance done fail remove help" -f -a "advance" -d 'Advance the task\'s subtask pointer'
complete -c do-harness -n "__fish_do_harness_using_subcommand task; and not __fish_seen_subcommand_from export import list show add advance done fail remove help" -f -a "done" -d 'Mark a task done once its sensor-gated subtasks have passed'
complete -c do-harness -n "__fish_do_harness_using_subcommand task; and not __fish_seen_subcommand_from export import list show add advance done fail remove help" -f -a "fail" -d 'Mark a task failed'
complete -c do-harness -n "__fish_do_harness_using_subcommand task; and not __fish_seen_subcommand_from export import list show add advance done fail remove help" -f -a "remove" -d 'Remove or cancel a task'
complete -c do-harness -n "__fish_do_harness_using_subcommand task; and not __fish_seen_subcommand_from export import list show add advance done fail remove help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c do-harness -n "__fish_do_harness_using_subcommand task; and __fish_seen_subcommand_from help" -f -a "import" -d 'Validate plans/tasks.json against the state database'
...
complete -c do-harness -n "__fish_do_harness_using_subcommand distill" -l min-strikes -d 'Strike count at or above which a signature sculpts a scaffold (default: the fail-fast threshold)' -r
complete -c do-harness -n "__fish_do_harness_using_subcommand distill" -l task -d 'Scope strike lookup to this task id' -r
...
complete -c do-harness -n "__fish_do_harness_using_subcommand loc" -l format -d 'Output format' -r -f -a "text\t'Human-readable text output'
json\t'Machine-readable JSON output'"
...
json\t'Machine-readable JSON output'"
complete -c do-harness -n "__fish_do_harness_using_subcommand eval" -l approver -d 'Approver identity recorded with `--bless` (defaults to `DO_HARNESS_APPROVER` or the git user email)' -r
complete -c do-harness -n "__fish_do_harness_using_subcommand eval" -l agent-cmd -d 'Run this shell command once per eval case instead of the deterministic walkthrough (real Skill Lift). cwd is the sandbox root; the prompt is in `$DO_HARNESS_PROMPT` and on stdin; stdout is saved to `agent_stdout.txt` for assertions' -r
...
complete -c do-harness -n "__fish_do_harness_using_subcommand overlap" -l threshold -d 'Cosine similarity at or above which a pair prints as WARN' -r
complete -c do-harness -n "__fish_do_harness_using_subcommand overlap" -l format -d 'Output format' -r -f -a "text\t'Human-readable text output'
json\t'Machine-readable JSON output'"
...
complete -c do-harness -n "__fish_do_harness_using_subcommand maintenance" -l prune-beats -d 'Delete beats older than this many days (keeps the most recent per task)' -r
...
complete -c do-harness -n "__fish_do_harness_using_subcommand dora" -l days -d 'Rolling window in days (overrides the pinned policy for this run)' -r
complete -c do-harness -n "__fish_do_harness_using_subcommand dora" -l format -d 'Output format' -r -f -a "text\t'Human-readable text output'
json\t'Machine-readable JSON output'"
complete -c do-harness -n "__fish_do_harness_using_subcommand dora" -l source -d 'Where the numbers come from' -r -f -a "git\t'Git history only: hermetic, offline, clock-injected'
gh\t'Git history plus opt-in `gh` enrichment (network; never in CI)'"
...
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora completions man help" -f -a "version" -d 'Print CLI version information'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora completions man help" -f -a "verify" -d 'Run computational sensors'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora completions man help" -f -a "list" -d 'List sensor names'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora completions man help" -f -a "explain" -d 'Explain which sensors the current change selects, without running them'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora completions man help" -f -a "status" -d 'Report verification evidence freshness without running sensors'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora completions man help" -f -a "pr" -d 'Deterministic PR analysis (read-only; works in any git repository)'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora completions man help" -f -a "skills" -d 'Inspect and select skills by progressive disclosure'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora completions man help" -f -a "init-db" -d 'Apply pending database migrations'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora completions man help" -f -a "seed" -d 'Seed invariants from plans/invariants.json'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora completions man help" -f -a "init" -d 'Scaffold a harness workspace in a target directory'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora completions man help" -f -a "task" -d 'Inspect and export task state'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora completions man help" -f -a "trace" -d 'Record and list interaction traces'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora completions man help" -f -a "distill" -d 'Extract a heuristic from a resolved trace into a skill. Review output against the anti-AI-slop checklist (.agents/skills/skill-creator/references/anti_ai_slop.md)'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora completions man help" -f -a "errors" -d 'Inspect and clear fail-fast error signatures'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora completions man help" -f -a "loc" -d 'Report line-of-code state for the 500-LOC invariant'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora completions man help" -f -a "split" -d 'Extract a large top-level item into a sibling module'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora completions man help" -f -a "eval" -d 'Validate skill structure and benchmark skill evals'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora completions man help" -f -a "hook" -d 'Manage git hooks that run `do-harness verify`'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora completions man help" -f -a "doctor" -d 'Run diagnostic checks on binary resolution and git hook health'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora completions man help" -f -a "metrics" -d 'Report harness trends: sensor stats, strikes, eval pass-rate history'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora completions man help" -f -a "overlap" -d 'Rank skill pairs by guidance overlap (Tier-2 distinctiveness advisory)'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora completions man help" -f -a "maintenance" -d 'Prune old beats and compact the state database'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora completions man help" -f -a "compliance" -d 'Print compliance mapping to OWASP Agentic Top 10, NIST AI RMF, and EU AI Act'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora completions man help" -f -a "audit-chain" -d 'Recompute workflow event hash chain and report first divergence'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora completions man help" -f -a "dora" -d 'Derive DORA deployment metrics from git history (deterministic, read-only)'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora completions man help" -f -a "completions" -d 'Generate shell completions'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora completions man help" -f -a "man" -d 'Generate man page documentation'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors loc split eval hook doctor metrics overlap maintenance compliance audit-chain dora completions man help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and __fish_seen_subcommand_from pr" -f -a "readiness" -d 'Check merge readiness for a pull request'
