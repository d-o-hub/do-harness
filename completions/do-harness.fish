...
complete -c do-harness -n "__fish_do_harness_using_subcommand skills; and not __fish_seen_subcommand_from suggest help" -l root -d 'Workspace root override (default: walk up from cwd)' -r -f -a "(__fish_complete_directories)"
complete -c do-harness -n "__fish_do_harness_using_subcommand skills; and not __fish_seen_subcommand_from suggest help" -l config -d 'Explicit path to do-harness.toml' -r -F
complete -c do-harness -n "__fish_do_harness_using_subcommand skills; and not __fish_seen_subcommand_from suggest help" -l color -d 'Color output (auto, always, never)' -r
complete -c do-harness -n "__fish_do_harness_using_subcommand skills; and not __fish_seen_subcommand_from suggest help" -l output -d 'Default output file path' -r -F
complete -c do-harness -n "__fish_do_harness_using_subcommand skills; and not __fish_seen_subcommand_from suggest help" -s v -l verbose -d 'Verbosity level (-v, -vv)'
complete -c do-harness -n "__fish_do_harness_using_subcommand skills; and not __fish_seen_subcommand_from suggest help" -s q -l quiet -d 'Suppress non-error messages'
complete -c do-harness -n "__fish_do_harness_using_subcommand skills; and not __fish_seen_subcommand_from suggest help" -l dry-run -d 'Dry run without side effects'
complete -c do-harness -n "__fish_do_harness_using_subcommand skills; and not __fish_seen_subcommand_from suggest help" -s h -l help -d 'Print help'
complete -c do-harness -n "__fish_do_harness_using_subcommand skills; and not __fish_seen_subcommand_from suggest help" -s V -l version -d 'Print version'
complete -c do-harness -n "__fish_do_harness_using_subcommand skills; and not __fish_seen_subcommand_from suggest help" -f -a "suggest" -d 'Rank skills by relevance to a query using metadata only'
complete -c do-harness -n "__fish_do_harness_using_subcommand skills; and not __fish_seen_subcommand_from suggest help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr skills init-db seed init task trace distill errors eval hook doctor metrics overlap maintenance compliance audit-chain dora completions man help" -f -a "distill" -d 'Extract a heuristic from a resolved trace'
