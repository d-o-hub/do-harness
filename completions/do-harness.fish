...
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr init-db seed init task trace distill errors eval hook doctor metrics overlap maintenance compliance audit-chain completions man help" -f -a "verify" -d 'Run computational sensors'
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr init-db seed init task trace distill errors eval hook doctor metrics overlap maintenance compliance audit-chain completions man help" -f -a "list" -d 'List sensor names'
...
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr init-db seed init task trace distill errors eval hook doctor metrics overlap maintenance compliance audit-chain completions man help" -f -a "pr" -d 'Deterministic PR analysis (read-only; works in any git repository)'
...
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr init-db seed init task trace distill errors eval hook doctor metrics overlap maintenance compliance audit-chain completions man help" -f -a "task" -d 'Inspect and export task state'
...
complete -c do-harness -n "__fish_do_harness_using_subcommand help; and not __fish_seen_subcommand_from version verify list explain status pr init-db seed init task trace distill errors eval hook doctor metrics overlap maintenance compliance audit-chain completions man help" -f -a "overlap" -d 'Rank skill pairs by guidance overlap (Tier-2 distinctiveness advisory)'
